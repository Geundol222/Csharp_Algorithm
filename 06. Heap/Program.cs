namespace _06._Heap
{
    internal class Program
    {
		 ...
		 *  
		 * <트리에 추가>
		 * 만약 최 상단 부모보다 작은 값이 들어왔을 경우 그 값과 부모를 비교하여 더 작은 값이 위로 올라가는 방식을 반복
		 * 
		 * <제거>
		 * 맨 뒤의 자료를 최 상단으로 올리고, 부모와 자식을 비교하여 계속 올라가고 내려가고 반복
		 * 이진트리는 왼쪽 아니면 오른쪽 이므로, 왼쪽을 보고 조건이 아니면 오른쪽에서만 연산을 진행하므로 logn의 시간복잡도를 가지며 매우 효율적
		 ******************************************************/
